...
import me.seven.bpatch.ui.CrashHandleActivity
import me.seven.bpatch.util.APatchCli
import me.seven.bpatch.util.APatchKeyHelper
import me.seven.bpatch.util.Version
import me.seven.bpatch.util.getRootShell
import me.seven.bpatch.util.rootShellForResult
import me.seven.bpatch.util.verifyAppSignature
...
class APApplication : Application(), Thread.UncaughtExceptionHandler {
    ...
    companion object {
        ...
        private const val magiskbboot_BIN_PATH = APATCH_BIN_FOLDER + "magiskbboot"
        ...
        fun installApatch() {
            ...
            val cmds = arrayOf(
                ...
                "cp -f ${nativeDir}/libbpd.so $APD_PATH",
                "chmod +x $APD_PATH",
                "ln -s $APD_PATH $APD_LINK_PATH",
                "restorecon $APD_PATH",

                "cp -f ${nativeDir}/libmagiskbpolicy.so $MAGISKPOLICY_BIN_PATH",
                ...
                "cp -f ${nativeDir}/libmagiskbboot.so $magiskbboot_BIN_PATH",
                "chmod +x $magiskbboot_BIN_PATH",
                ...
                "${nativeDir}/libmagiskbpolicy.so --magisk --live",
            )
