...
import me.seven.bpatch.APApplication.Companion.SUPERCMD
import me.seven.bpatch.BuildConfig
import me.seven.bpatch.apApp
import me.seven.bpatch.ui.screen.MODULE_TYPE
import java.io.File
...
private fun getKPatchPath(): String {
    return apApp.applicationInfo.nativeLibraryDir + File.separator + "libbpatch.so"
}
...
fun listModules(): String {
    ...
    withNewRootShell{
       newJob().add("cp /data/user/*/me.seven.bpatch/patch/ori.img /data/adb/ap/ && rm /data/user/*/me.seven.bpatch/patch/ori.img")
